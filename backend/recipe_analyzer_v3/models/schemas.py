...
class NutritionPerPerson(BaseModel):
    ...
    calories_percentage_of_daily_needs: Optional[float] = Field(..., description="Percentage of daily calorie needs for John Doe")
...
class RecipeCardWithNutrition(RecipeCard):
    """Extended recipe card including nutritional information"""
    nutrition: NutritionPerPerson = Field(..., description="Nutritional information per serving")
